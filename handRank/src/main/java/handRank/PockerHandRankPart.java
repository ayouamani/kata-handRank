...
import models.Card;
import models.CategoryCardRank;
import models.Player;
import models.FinalMsg;
import models.Value;

public class PockerHandRankPart {
	CardRankComparator compareCardRank;
    List<Card> black;
    List<Card> white;
    Map<String, Integer> player = new HashMap<>();
    FinalMsg summary = new FinalMsg();

    public PockerHandRankPart(List<Card> black, List<Card> white, CardRankComparator compareCardRank){
        this.black = black;
        this.white = white;
        this.compareCardRank = compareCardRank;
    }

    public String pockerHandRankPart() {
