...
public class CardRankComparatorImpl extends Rank implements CardRankComparator {
    HighCard highCard;
    Pair pair;
    TwoPairs twoPair;
    ...
    public CardRankComparatorImpl(HighCard highCard, Pair pair, TwoPairs twoPair,
    ...
    public List<Card> getRemainingCardOfPair(List<Card> cards) {
        return pair.getRestCardOfPair(cards);
    }
